...
import com.geekbrains.spring.web.core.exceptions.WrongStatusOfOrderException;
...
public class PayPalService {
    ...
    public OrderRequest createOrderRequest(Long orderId) {
        com.geekbrains.spring.web.core.entities.Order order = orderService.findByIdAndStatus(orderId, OrderStatus.CREATED).orElseThrow(() ->
                new WrongStatusOfOrderException("Заказ не в статусе CREATED"));
